...
export class CustomHighlightDirective {
  ...
  // we can set alias to directive property as of directive's name if we have only one property or only one main property
  // in this way, we'll not have to use directive name along with directive's property
  @Input('appCustomHighlight') defaultColor: string = 'transparent';
